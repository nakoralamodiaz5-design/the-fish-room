...
function checkout(){ if(!state.cart.length) return; location.href="checkout.html"; }x ${x.p.name}`).join(", ");location.href=`https://wa.me/34612412469?text=${encodeURIComponent("Hola The Fish Room, quiero pedir: "+text+" . Total orientativo: "+cartTotal().toFixed(2)+" €. Quiero recogerlo en tienda.")}`}
